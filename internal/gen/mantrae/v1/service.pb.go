...
func (x *UpdateServiceRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
func (x *DeleteServiceRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
const file_mantrae_v1_service_proto_rawDesc = "" +
	...
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\xf7\x01\n" +
	...
	"\x04name\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04name\x12\x18\n" +
	"\aenabled\x18\x04 \x01(\bR\aenabled\x12/\n" +
	"\x06config\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06config\x126\n" +
	"\x04type\x18\x06 \x01(\x0e2\x18.mantrae.v1.ProtocolTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\"F\n" +
	"\x15UpdateServiceResponse\x12-\n" +
	"\aservice\x18\x01 \x01(\v2\x13.mantrae.v1.ServiceR\aservice\"\x8f\x01\n" +
	"\x14DeleteServiceRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	"\x02id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02id\x126\n" +
	"\x04type\x18\x03 \x01(\x0e2\x18.mantrae.v1.ProtocolTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\"\x17\n" +
	...
	"\fListServices\x12\x1f.mantrae.v1.ListServicesRequest\x1a .mantrae.v1.ListServicesResponse\"\x03\x90\x02\x01B\xa9\x01\n" +
	"\x0ecom.mantrae.v1B\fServiceProtoP\x01Z@github.com/mizuchilabs/mantrae/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
