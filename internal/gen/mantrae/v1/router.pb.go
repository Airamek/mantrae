...
func (x *GetRouterRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
type UpdateRouterRequest struct {
	...
	Config        *structpb.Struct       `protobuf:"bytes,5,opt,name=config,proto3" json:"config,omitempty"`
	Enabled       bool                   `protobuf:"varint,6,opt,name=enabled,proto3" json:"enabled,omitempty"`
	DnsProviders  []*DNSProvider         `protobuf:"bytes,7,rep,name=dns_providers,json=dnsProviders,proto3" json:"dns_providers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateRouterRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
func (x *DeleteRouterRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
const file_mantrae_v1_router_proto_rawDesc = "" +
	...
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\xb4\x02\n" +
	...
	"\x06config\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06config\x12\x18\n" +
	"\aenabled\x18\x06 \x01(\bR\aenabled\x12<\n" +
	"\rdns_providers\x18\a \x03(\v2\x17.mantrae.v1.DNSProviderR\fdnsProviders\"B\n" +
	"\x14UpdateRouterResponse\x12*\n" +
	"\x06router\x18\x01 \x01(\v2\x12.mantrae.v1.RouterR\x06router\"\x8e\x01\n" +
	"\x13DeleteRouterRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	"\x02id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02id\x126\n" +
	"\x04type\x18\x03 \x01(\x0e2\x18.mantrae.v1.ProtocolTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\"\x16\n" +
	...
	"\vListRouters\x12\x1e.mantrae.v1.ListRoutersRequest\x1a\x1f.mantrae.v1.ListRoutersResponse\"\x03\x90\x02\x01B\xa8\x01\n" +
	"\x0ecom.mantrae.v1B\vRouterProtoP\x01Z@github.com/mizuchilabs/mantrae/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
