...
func (x *GetMiddlewareRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
func (x *DeleteMiddlewareRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
const file_mantrae_v1_middleware_proto_rawDesc = "" +
	...
	"\x04toml\x18\x03 \x01(\tR\x04toml\"\x8f\x01\n" +
	"\x14GetMiddlewareRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	"\x02id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02id\x126\n" +
	"\x04type\x18\x03 \x01(\x0e2\x18.mantrae.v1.ProtocolTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\"O\n" +
	...
	"middleware\x18\x01 \x01(\v2\x16.mantrae.v1.MiddlewareR\n" +
	"middleware\"\x99\x02\n" +
	"\x17UpdateMiddlewareRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	...
	"middleware\x18\x01 \x01(\v2\x16.mantrae.v1.MiddlewareR\n" +
	"middleware\"\x92\x01\n" +
	"\x17DeleteMiddlewareRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	"\x02id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02id\x126\n" +
	...
	"\x14GetMiddlewarePlugins\x12'.mantrae.v1.GetMiddlewarePluginsRequest\x1a(.mantrae.v1.GetMiddlewarePluginsResponse\"\x03\x90\x02\x01B\xac\x01\n" +
	"\x0ecom.mantrae.v1B\x0fMiddlewareProtoP\x01Z@github.com/mizuchilabs/mantrae/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
