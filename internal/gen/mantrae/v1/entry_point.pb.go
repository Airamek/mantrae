...
func (x *GetEntryPointRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
func (x *DeleteEntryPointRequest) GetProfileId() int64 {
	if x != nil {
		return x.ProfileId
	}
	return 0
...
const file_mantrae_v1_entry_point_proto_rawDesc = "" +
	...
	"\ventry_point\x18\x01 \x01(\v2\x16.mantrae.v1.EntryPointR\n" +
	"entryPoint\"\xc1\x01\n" +
	"\x17UpdateEntryPointRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	...
	"\ventry_point\x18\x01 \x01(\v2\x16.mantrae.v1.EntryPointR\n" +
	"entryPoint\"Z\n" +
	"\x17DeleteEntryPointRequest\x12&\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\tprofileId\x12\x17\n" +
	"\x02id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02id\"\x1a\n" +
	...
	"\x0fListEntryPoints\x12\".mantrae.v1.ListEntryPointsRequest\x1a#.mantrae.v1.ListEntryPointsResponse\"\x03\x90\x02\x01B\xac\x01\n" +
	"\x0ecom.mantrae.v1B\x0fEntryPointProtoP\x01Z@github.com/mizuchilabs/mantrae/internal/gen/mantrae/v1;mantraev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Mantrae.V1\xca\x02\n" +
